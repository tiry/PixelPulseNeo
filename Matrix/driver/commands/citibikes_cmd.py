...
class CitibikesCmd(PictureScrollBaseCmd):
    ...
    def generate_image(self, args, kwargs):
        ...
        icon = Image.open(get_icons_dir("citibike/logo_wide_small.png")).convert("RGB")
        img.paste(icon, (int((3 * 64 - 94) / 2), 2))

        x = 10
        iconElec = Image.open(get_icons_dir("citibike/elec.png")).convert("RGB")
        ...
        x = 70
        iconFree = Image.open(get_icons_dir("citibike/normal.png")).convert("RGB")
