...
class SpotifyCmd(PictureScrollBaseCmd):
    ...
    def render_no_track(self) -> Image.Image:
        if self.cached_placeholder is None:
            ...
            icon: Image.Image = Image.open(get_icons_dir("spotify/spotify.png")).convert("RGB")      
    ...
    def render_track_info(self) -> Image.Image:
        ...
        if self.track_info["track_id"]!= self.cached_track_id or self.cached_image is None:
            ...
            xoffset: int = 64  + self._compute_text_position(self.track_info["artist_name"], font, 128)
            ...
            end: str = str(datetime.timedelta(seconds = int(self.track_info["track_duration"]/1000)))[-5:]
        ...
        start: str = str(datetime.timedelta(seconds = int(self.track_info["track_position"]/1000)))[-5:]
