from Matrix.driver.commands.base import PictureScrollBaseCmd, get_total_matrix_width, get_total_matrix_height
from PIL import Image
from Matrix.driver.commands.simu.conway import runStep, randomGrid, ON, OFF
import random
